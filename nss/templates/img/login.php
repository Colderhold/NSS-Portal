...
<br><br><br><br>
  ...
  <form  action='' method='post' style="border:1px solid #ccc">
    ...
    <input type="password" placeholder="Enter Password" name="password" required>
      ...
      <button type="submit" class="signupbtn" name='submit' style="margin-left: 70px">Sign In</button>
    </div>
 ...
 <div class="card" style="box-shadow: 5px 5px 10px #888888">
      ...
      <div style='padding: 10px; font-weight: bold; color: black'>                          Dont have an Account ?
