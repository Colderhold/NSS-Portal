...
<form  action='' method='post' style="border:1px solid #ccc">
 ...
 <h2>Do you want to register for Cleanup Drive?</h2>
...
<?php
    ...
    $maths_marks = $_POST['beach'];
    header("Location: profile.php");
 	}
 	$sql= "UPDATE maths_marks SET beach= '$maths_marks' WHERE id='$login_session' ";
